    ...
    <div className="fade-in">
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 12 }}>
          ...
          <tbody>
            {inspItems.map(r => {
              ...
              return (
                <tr key={key} style={{ borderBottom: '1px solid #101014' }}>
                    ...
                    {r.insp > 0 ? (
                      <button
                        ...
                        style={{
                          ...
                          borderColor: on ? 'var(--yellow)' : '#2a2a2a',
                          color: on ? '#000' : '#666',
      ...
      {anyOn && (
        <div style={{
          ...
          background: '#0c130a', border: '1px solid #1e2e14', borderRadius: 4,
        }}>
          <div style={{ color: 'var(--green)', fontSize: 10, letterSpacing: 2, marginBottom: 8 }}>
            IMPACT OF INCLUSIONS
          </div>
          {rows.filter(r => inspToggles[`${r.sku}_${r.loc}`]).map(r => (
            <div key={`${r.sku}_${r.loc}`} style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 5, fontSize: 11 }}>
